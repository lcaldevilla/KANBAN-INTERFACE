...
class GraficaUrgentesController extends Controller
{
    ...
    public function index()
    {
        ...
        array_push($aux_array_ano, DB::raw('YEAR(CONVERT(DATE, pr.fecha_creacion))'), '=', date("Y"));
       ...
       return view('graficaUrgentes', compact('servicios', 'almacenes', 'lava', 'anos'))->render();
    }
   ...
   public function update(Request $request)
   {
    ...
    $lava->LineChart('Unidades', $unidades, ['title' => 'Curva consumos', 'curveType' => 'none', 'pointsVisible' => true,]);
       return view('graficaUrgentes_chart', compact('lava'))->render();
   }

...
class consumosAgrupadosController extends Controller
{
    ...
    public function ajaxRequestPostUpdate(Request $request)
    {
        ...
        return view('consumos_agrupados_pagination', compact('consumos', 'total_Registros', 'total_articulos'))->render();
    ...
    public function index()
    {
        ...
        return view('consumos_agrupados', compact('consumos', 'servicios', 'almacenes', 'total_Registros', 'total_articulos'))->render();
    }
}

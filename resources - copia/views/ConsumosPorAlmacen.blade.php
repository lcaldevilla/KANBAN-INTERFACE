...
<h1 class="standard-margin">Consumos Artículos Por Almacén </h1>
...
<div class="table-responsive standard-margin" id="table_data">
    @include('consumos_por_almacen_pagination')
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#servicio").change(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('consumosPorAlmacen.post') }}",
                data: {
                    status: status
                },
        ...
        $("#btnActualizar").click(function(e) {
            ...
            $.ajax({
                url: "{{ route('consumosPorAlmacen.update') }}",
                method: "POST",
                data: {
                    almacen: almacen,
                    servicio: servicio,

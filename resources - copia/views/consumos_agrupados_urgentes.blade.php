...
<h1 class="standard-margin">Consumos Artículos Agrupados Urgentes </h1>
...
<br />
    ...
    <div class="table-responsive standard-margin" id="table_data">
        @include('consumos_urgentes_agrupados_pagination')
    </div>
    ...
    $(document).ready(function() {
        ...
        $("#servicio").change(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('consumosAgrupadosUrgentes.post') }}",
                data: {
                    status: status
                },
        ...
        $("#btnActualizar").click(function(e) {
            ...
            $.ajax({
                url: "{{ route('consumosAgrupadosUrgentes.update') }}",
                method: "POST",
                data: {
                    almacen: almacen,
                    servicio: servicio,

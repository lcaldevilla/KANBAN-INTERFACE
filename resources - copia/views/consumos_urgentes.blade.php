...
<h1 class="standard-margin">Consumos artículos urgentes </h1>
...
<br />
    ...
    <div class="table-responsive standard-margin" id="table_data">
        @include('consumos_pagination_urgentes')
    </div>
    ...
    $(document).ready(function() {
        ...
        $("#servicio").change(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('consumosUrgentes.post') }}",
                data: {
                    status: status
                },
        ...
        $("#btnActualizar").click(function(e) {
            ...
            $.ajax({
                url: "{{ route('consumosUrgentes.update') }}",
                method: "POST",
                data: {
                    almacen: almacen,
                    servicio: servicio,
